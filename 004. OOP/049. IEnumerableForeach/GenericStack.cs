...
namespace OOP
{
    ...
    class GenericStack<T> : IEnumerable<T>
    {
        ...
        {
            // or we could have passed the stack to the StackEnumerator constructor
            // and then we could have used the stack.items and stack.Count
            // inside the StackEnumerator class
            // return new StackEnumerator(GenericStack<T> stack);
            // or
    ...
    public class StackEnumerator<T> : IEnumerator<T>
    {
        ...
        // and then we could have used the stack.items and stack.Count
        // inside the StackEnumerator class
        // public StackEnumerator(GenericStack<T> stack)
        // {
        //     array = stack.items;
        ...
        // above is the same as the property below
        // public T Current
        // {
        //     get
        //     {
        ...
        {
            // from last position to the first position
            position--;
            return position >= 0;
        }
